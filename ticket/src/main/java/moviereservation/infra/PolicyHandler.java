...
public class PolicyHandler {
    ...
    public void wheneverCanceledpayment_IncreaseTicket(
        @Payload Canceledpayment canceledpayment
    ) {
        Canceledpayment event = canceledpayment;
        System.out.println(
            "\n\n##### listener IncreaseTicket : " + canceledpayment + "\n\n"
        );
    ...
    public void wheneverPaid_DecreaseTicket(@Payload Paid paid) {
        Paid event = paid;
        System.out.println(
            "\n\n##### listener DecreaseTicket : " + paid + "\n\n"
        );
